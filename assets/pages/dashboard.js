    ...
    return {
        ...
        initEasyPieCharts: function() {
            ...
            $('.easy-pie-chart .number.transactions').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: PECO.getBrandColor('yellow')
            });
            ...
            $('.easy-pie-chart .number.visits').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: PECO.getBrandColor('green')
            });
            ...
            $('.easy-pie-chart .number.bounce').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: PECO.getBrandColor('red')
            });
        ...
        initChat: function() {
            ...
            $('body').on('click', '.message .name', function(e) {
                ...
                PECO.scrollTo(input); // scroll to input if needed
            });
        ...
        initDashboardDaterange: function() {
            ...
            $('#cad-report-range').daterangepicker({
                "ranges": {
                    'Today': [moment(), moment()],
                ...
                //"endDate": "11/14/2015",
                opens: (PECO.isRTL() ? 'right' : 'left'),
            }, function(start, end, label) {
                if ($('#cad-report-range').attr('data-display-range') != '0') {
                    $('#cad-report-range span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
                }
            });
             if ($('#cad-report-range').attr('data-display-range') != '0') {
                $('#cad-report-range span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
            }
            $('#cad-report-range').show();
        },
        ...
        initAmChart3: function() {
            ...
            var chart = AmCharts.makeChart("dashboard_amchart_3", {
                ...
                "addClassNames": true,
                "theme": "light",
                "path": PECO.base_url() + "assets/global/plugins/amcharts/ammap/images/",
                "autoMargins": true,
                "marginLeft": 30,
                //"marginRight": 8,
                "marginTop": 10,
        ...
        Collections: function() {
            setInterval(function(){
                ...
                $.get(PECO.base_url() + 'tellering/totalcollectiontoday', function(d){
                    var today_coll_box = $('[data-counter="counterup"]', document).eq(0);
                    today_coll_box.attr('data-value', d.amt);
                    today_coll_box.text(d.amt);
                }, 'json');

                $.get(PECO.base_url() + 'tellering/totalcollectionthisweek', function(d){
                    var today_coll_box = $('[data-counter="counterup"]', document).eq(1);
                    today_coll_box.attr('data-value', d.amt);
                    today_coll_box.text(d.amt);
                }, 'json');

                $.get(PECO.base_url() + 'tellering/totalcollectionthismonth', function(d){
                    var today_coll_box = $('[data-counter="counterup"]', document).eq(2);
                    today_coll_box.attr('data-value', d.amt);
                    today_coll_box.text(d.amt);
                }, 'json');

                $.get(PECO.base_url() + 'tellering/totalcollectionthisyear', function(d){
                    var today_coll_box = $('[data-counter="counterup"]', document).eq(3);
                    today_coll_box.attr('data-value', d.amt);
                    today_coll_box.text(d.amt);
                }, 'json');
