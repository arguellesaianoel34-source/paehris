var INBOX = function () {
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": [PECO.base_url()+"assets/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: PECO.base_url()+'assets/global/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
    ...
    return {
        ...
        init: function () {
            ...
            if (PECO.getURLParameter("a") === "view") {
                loadMessage();
            } else if (PECO.getURLParameter("a") === "compose") {
                loadCompose();
            } else {
