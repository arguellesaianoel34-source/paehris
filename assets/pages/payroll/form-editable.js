var FormEditable = function () {
    ...
    var a = function (a, e) {
        ...
        "inline" == App.getURLParameter("mode") ? ($.fn.editable.defaults.mode = "inline", $("#inline").attr("checked", !0)) : $("#inline").attr("checked", !1), $.fn.editable.defaults.inputclass = "form-control", $.fn.editable.defaults.url = "/post", $("#username").editable({
            url: "/post",
            type: "text",
            pk: 1,
            name: "username",
