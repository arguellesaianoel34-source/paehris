    ...
    e.AmStockChart = e.Class({
        ...
        parseStockData: function(a, b, c, d, k) {
            ...
            e.ifArray(a.stockEvents) ? 0 < f.processTimeout ? setTimeout(function() {
                ...
                f.parseEvents(a, f.panels, f.stockEventsSettings, f.firstDayOfWeek, f, f.dataDateFormat) : (a.dataParsed = !0, f.onDataUpdated())
        },
        parseEvents: function(a, b, c, d, k, f) {
            ...
            for (n = 0; n < h; n++) {
                ...
                for (g = 0; g < d.length; g++) m = d[g], q = m.graph, e.isString(q) && (q = e.getObjById(t, q)) && (m.graph = q),
                q && (m.panel = q.chart)
            }
            for (var y in l)
        ...
        createLayout: function() {
            ...
            if ("left" == b || "left" == c) a = document.createElement("div"), a.className = d + "-left-div", a.style.cssFloat = "left", a.style.styleFloat = "left", a.style.width = "0px", a.style.position =
                "absolute", e.appendChild(a), this.leftContainer = a;
    ...
    e.PeriodSelector = e.Class({
        ...
        write: function(a) {
            ...
            if (b.inputFieldsEnabled) {
                ...
                m.className = "amChartsInputField " + d + "-start-date-input form-control input-sm date-picker-start";
                ...
                m.className = "amChartsInputField " + d + "-end-date-input form-control input-sm date-picker-end ";
                k && e.applyStyles(m.style, k.PeriodInputField);
                m.style.textAlign = "center";
                m.onblur = function() {
                    b.handleCalChange()
            ...
            if (e.ifArray(n)) {
                ...
                b.periodContainer = g;
                var t;
                for (a = 0; a < n.length; a++) c = n[a], t = document.createElement("input"),
                    t.type = "button", t.value = c.label, t.period = c.period, t.count = c.count, t.periodObj = c, t.className = "amChartsButton btn btn-default " + d + "-period-input btn", k && e.applyStyles(t.style, k.PeriodButton), f && (t.style.width = b.width - 1 + "px"), t.style.boxSizing = "border-box", g.appendChild(t), b.addEventListeners(t), c.button = t;
        ...
        markButtonAsSelected: function() {
            if (!this.skipMark) {
                ...
                for (f = b.length - 1; 0 <= f; f--) {
                    var l = b[f],
                        h = l.button;
                    l.startTime && l.endTime && c == l.startTime && d == l.endTime && (this.unselectButtons(), h.className = "amChartsButtonSelected  btn btn-primary btn-xs " + a.classNamePrefix + "-period-input-selected",
        ...
        unselectButtons: function() {
            ...
            for (c = b.length - 1; 0 <= c; c--) {
                var k = b[c].button;
                k.className = "amChartsButton btn btn-default btn-xs " + a.classNamePrefix + "-period-input";
    ...
    e.DataSetSelector = e.Class({
        ...
        write: function(a) {
            ...
            if (1 < b.countDataSets("showInSelect")) {
                ...
                m.className = k.classNamePrefix + "-data-set-select form-control input-sm select2";
                a.appendChild(m);
