...
<div class="wrapper">
    <div class="login-box">
        ...
        <div class="login-box-body animated fadeInRight fast">
            ...
            <form id="form_forgotpassword"  class="form-without-legend" action="<?php echo base_url();?>peco/sendforgotpasswordlink" method="post" >
                <h4><i class="fa fa-question text-warning"></i> Forgot Password<span class="query-stats pull-right small"></span></h4>


                <div class="form-group margin-top-30 form-md-line-input has-feedback <?php echo $hass_error;?> row">
                    <div class="input-icon">
                        <input required type="text" class="form-control input-sm" name="username" placeholder="Username">
                        <div class="form-control-focus"></div>
                        <i class="fa fa-user"></i>
                    </div>
                </div>

                <div class="form-group form-md-line-input has-feedback <?php echo $hass_error;?> row">
                    <div class="input-icon">
                        ...
                        <span class="help-block">Enter email address associated to this account.</span>
                ...
                <div class="form-group margin-top-30 form-md-line-input has-feedback <?php echo $hass_error;?> row">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">
                            ...
                            <input required type="text" class="form-control input-lg" id="input_captcha" name="captcha" placeholder="Enter captcha code..">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span class="pull-right" style="text-align:right">
                                    <button class="btn btn-primary" type="submit"><i class="fa fa-mail-forward"></i> Send Reset Link</button>
                                    <a href="<?php echo base_url(); ?>peco/registration" class="btn btn-default"><i class="fa fa-edit"></i> Register</a>
