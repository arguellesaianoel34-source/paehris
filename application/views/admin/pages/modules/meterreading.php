            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-helper">New Customer Meter Reading</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                      ...
                      <!--      <div class="form-group form-md-line-input has-error"> -->
									 <!-- deleted top for aesthetic purposes -->
                            ...
                            <div class="form-group form-md-line-input ">
                                ...
                                <div class="col-md-4">
                                    <input name="warantydate" type="text" class="form-control input-sm" id="waranty" placeholder="Warantey Date">
                                    <div class="form-control-focus">
                                    </div>
          	...
          	<div class="portlet light">
               <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-sharp bold uppercase">ESSR</span>
                        <br>
                ...
                <div class="form-group form-md-line-input">
                	<div class="col-md-12">
                    	<label>ESSR: </label>
                        <input id="essr" name="essr" type="text" class="form-control  input-sm " placeholder="ESSR">
								   <button type="submit" id="save" class="btn blue btn-block btn-lg gray-stripe"><i class="fa fa-save fa-fw"></i> Search</button>
