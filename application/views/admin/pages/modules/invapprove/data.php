            ...
            <div class="portlet-body ">
                <div class="well">
                    <div class="row">
                        ...
                        <div class="col-md-4" id="trn_button_group">
                            ...
                            <?php if ($inv_qry->status != 0) {
                                if (in_array($inv_qry->status,array(302,303))) {
                                    ...
                                    if ($inv_qry->status == 301) {
                                        echo '<ul class="list-group summary column no-border">
                                <li class="list-group-item">
                                    ...
                                    <span class="col-md-8 font-blue-steel ">'.date('F j, Y').'</span>
                                        ...
                                        if (!isset($trnview) || $trnview == false) { ?>
                                            <div class="btn-group">
                                                <button id="btn_approve_inv" data-flowid="<?php echo $flowid;?>" data-stageid="<?php echo $stageid;?>" data-trnid="<?php echo $trnid;?>" class="btn btn-primary"><i class="fa fa-check"></i> Approve</button>
                                                ...
                                                <button id="btn_disapprove_inv" data-flowid="<?php echo $flowid;?>" data-stageid="<?php echo $stageid;?>" data-trnid="<?php echo $trnid;?>" class="btn btn-danger"><i class="fa fa-times"></i> Disapprove</button>
                                            </div>
                                        <?php   }
                                        if ($inv_qry->createdby == user_id()) {
                                            ?>
                                            <div class="btn-group">
                                                <button id="btn_cancel_rfq" data-flowid="<?php echo $flowid;?>" data-stageid="<?php echo $stageid;?>" data-trnid="<?php echo $trnid;?>" data-type="1207" class="btn btn-outline-danger text-danger"><i class="fa fa-trash"></i> Cancel TRN</button>
                                            </div>
                                            <?php
                                        }
                                    }
                    ...
                    <div id="inventory_transactions" class="hidden">
                        ...
                        <div class="tab-content" id="inv_reference_content">
                            <div class="tab-pane fade in" id="inventory_attachements">
                                <div class="row">
                                    <?php if ($inv_qry && $inv_qry->createdby == user_id()) { ?>
                                    <div class="col-md-6">
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption bold">
                                                    <i class="fa fa-clipboard"></i> Attachments
                                                </div>
                                            </div>
                                            <div class="portlet-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-bordered table-condensed" id="tbl_inv_trn_attachments">
                                                            <thead>
                                                            <th>#</th>
                                                            <th>File</th>
                                                            <th>View</th>
...
<script type="text/javascript">
    INVENTORY.trnApproval(<?php echo $dataid;?>);
