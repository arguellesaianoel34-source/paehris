...
if(super_admin() == false) {
    $app_flow_ids_arr = flow_id_arr('INVENTORY');
    $role_main_id = array();
...
<div class="row">
    <div class="col-md-12">
        ...
        <table style="width: 100%;" id="tbl_inv_trn_list" class="table table-hover table-striped table-condensed table-bordered no-footer tbl-sm" >
            <thead>
            <th></th>
            <th>Ctrl #</th>
            <th>Encoded</th>
