...
<link rel="stylesheet" type="text/css"
	href="<?php echo base_url(); ?>assets/global/plugins/datatables/plugins/fixedcolumn/css/fixedColumns.bootstrap.css" />
	...
	border: 1px solid #ccc;
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				<li><a href="javascript:;"><i class="fa fa-tag fa-fw"></i>
						2015-08-02-CPU0221-400 </a></li>
			</ul>
			<div class="page-toolbar">
				<div class="btn-group pull-right">
					<button class="btn btn-success btn-fit-height">
						<i class="fa fa-check fa-fw"></i>Approved
					</button>
					<button class="btn btn-danger btn-fit-height">
						<i class="fa fa-times fa-fw"></i>Disapprove
					</button>
					<button class="btn btn-warning btn-fit-height">
						<i class="fa fa-refresh fa-fw"></i>Approve w/ Condition
					</button>
					<button type="button"
						class="btn btn-fit-height grey-salt dropdown-toggle"
						data-toggle="dropdown" data-hover="dropdown" data-delay="1000"
						data-close-others="true">
						Send To <i class="fa fa-angle-down"></i>
					</button>
						...
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-edit"></i> <span
										class="caption-subject font-green-sharp bold uppercase">Information</span>
								...
								<div class="tools">
									<a href="javascript:;" class="collapse" data-original-title=""
										...
										title=""> </a> <a href="javascript:;" class="fullscreen"
										data-original-title="" title=""> </a> <a href="javascript:;"
										class="remove" data-original-title="" title=""> </a>
								</div>
							</div>
							<div class="portlet-body">
								<div class="row">
									<div class="col-md-3">
										<img
											src="<?php echo base_url(); ?>uploads/images/qr/2015-08-02-CPU022....png"
									...
									<div class="col-md-9">
										...
										Actual: <strong>P24,800.00</strong> Depreciation: <strong>0.30
											(month) </strong> Current: <strong>P23,800.00</strong>
										<hr>
										<legend>Status:</legend>
										<span class="label label-success">Deployed</span> Deployed
										Date: <strong>2015-07-10</strong> PO Date: <strong>2015-03-10</strong>
										<hr>
							...
							<div class="col-md-12 col-sm-12">
								<div class="portlet light ">
									<div class="portlet-title">
										...
										<div class="actions">
											<div class="btn-group">
												<a class="btn btn-sm btn-default btn-circle"
													href="javascript:;" data-toggle="dropdown"
													data-hover="dropdown" data-close-others="true"
													aria-expanded="false"> Filter By <i
													class="fa fa-angle-down"></i>
												</a>
												<div
													class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
													<label><div class="checker">
															<span class="checked"><input type="checkbox"></span>
														</div> Finance</label> <label><div class="checker">
															<span class="checked"><input type="checkbox" checked=""></span>
														</div> Membership</label> <label><div class="checker">
															<span class="checked"><input type="checkbox"></span>
														</div> Customer Support</label> <label><div class="checker">
															<span class="checked"><input type="checkbox" checked=""></span>
														</div> HR</label> <label><div class="checker">
					...
					<div class="col-md-12">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-edit"></i> <span
										class="caption-subject font-green-sharp bold uppercase">History</span>
					...
					<div class="col-md-12">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-edit"></i> <span
										class="caption-subject font-green-sharp bold uppercase">Image</span>
									<span class="caption-helper"></span>
								</div>
							...
							<div class="portlet-body">
								<div class="asset-pic">
									<img class="main"
										src="<?php echo base_url(); ?>uploads/images/assets/20150918_150820.jpg"
										width="100%" /> <img class="sub"
										src="<?php echo base_url(); ?>uploads/images/assets/20150918_150820.jpg" />
									<img class="sub"
										src="<?php echo base_url(); ?>uploads/images/assets/20150918_150820.jpg" />
									<img class="sub more tooltips " data-container="body"
										data-placement="bottom" data-html="true"
										data-original-title="View More"
										src="<?php echo base_url(); ?>assets/global/img/view-more-icon.png" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-edit"></i> <span
										...
										Attachedments</span> <span class="caption-helper">documents
										upon purchased</span>
								</div>
									...
									<li>
										<div class="col1">
											<div class="cont">
												...
												<div class="cont-col2">
													<div class="desc">
														<a href="javascript:;"> official-recipt.pdf </a>
													</div>
												</div>
											</div>
										</div>
									...
									<li>
										...
										<div class="col1">
											<div class="cont">
												...
												<div class="cont-col2">
													<div class="desc">
														<a href="javascript:;"> po-reciept.pdf </a>
													</div>
												</div>
											</div>
										</div>
									...
									<li>
										<div class="col1">
											<div class="cont">
												...
												<div class="cont-col2">
													<div class="desc">
														<a href="javascript:;"> prs-reciept.pdf </a>
													</div>
												</div>
											</div>
										</div>
