...
$info = get_ticket_logs_details($servno);

?>

<?php if($info) {
    if($info->acctid > 0) {
        $acctinfo = get_active_account_info($info->acctid);
        $servno_text = $acctinfo->servicenumber;
    ...
    <div class="row">
        <form class="form-horizontal" method="post" id="frm_legal_pay" action="<?php echo base_url('tellering/paylegal'); ?>">
            <div class="col-md-12">
                ...
                <input value="0" type="hidden" id="input_typesid" name="typesid" placeholder="" class="form-control" />

                <div class="portlet-title">
                    <div class="caption" style="font-size:18px;">
                        <i class="fa fa-user"></i>
                        <span class="caption-subject font-blue-sharp bold uppercase" id="appid"><?php echo ''; ?></span>
                        <span class="caption-subject font-green-sharp bold uppercase" id="name"><?php echo $name; ?></span>
                        <span class="caption-helper pull-right" id="addr"><?php echo $info->address; ?></span>
                    </div>
                </div>
                ...
                <div class="portlet-body table">
                        ...
                        <div class="col-md-4">
                            <ul class="list-group column summary no-border  list-group-sm">
                                <li class="list-group-item">
                                    <span class="col-md-4 label-name bold"><?php echo $servno_text; ?></span><span class="label-default col-md-8 number" id=""><?php echo $name; ?></span>
                                </li>
                                <li class="list-group-item">
                                    <span class="col-md-4 label-name">Address</span><span class="label-default col-md-8 number" id=""><?php echo $address; ?></span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="min-height: 30vh;">
                            <table width="100%" class="table table-hover table-bordered table-striped  tbl-sm tbl-zoom" id="tbl_penalties">
                                <thead>
                                <th><i class="fa fa-reorder"></i> Duedate</th>
                                <th>Account Code</th>
                                <th>No-VAT Amt</th>
                                <th>VAT amount</th>
                                <th>CWT</th>
                    ...
                    <div class="row" style="margin: 0px 0px;">
                        <div class="col-md-3">
                            <div class="form-group form-md-line-input pay-input  list-group-sm">
                    ...
                    <div class="col-md-6 ">
                        <ul class="list-group summary column list-group-sm">
                            <li class="list-group-item">
...
<script type="text/javascript">
    PAYMENTS.legal('<?php echo $servno; ?>');
</script>