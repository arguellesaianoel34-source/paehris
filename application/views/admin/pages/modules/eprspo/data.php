    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="btn-group <?php echo $hide; ?>">
                                <button class="btn btn-primary" id="btn_generate_po"><i class="fa fa-check"></i> Generate PO</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="btn-group">
                        <a href="frm_add_supplier_quotations" data-toggle="ajax-modal" data-arr="<?php echo $dataid;?>" title="Add Supplier Quotations" class="btn btn-primary inline"><i class="fa fa-plus"></i> Add Supplier</a>
                        <button class="btn btn-success inline" id="btn_refresh_po_list"><i class="fa fa-refresh"></i> Refresh</button>
                    </div>
                </div>
                <table class="table table-bordered table-striped table-condensed table-sm" id="tbl_po_suppliers">
                    <thead>
                    <th></th>
                    <th></th>
                    <th></th>
