        ...
        <div class="portlet light bordered">
            <div class="portlet-title tabbable-line">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-green-haze uppercase"> Purchase Order Approval </span>
                </div>
            </div>
                        ...
                        <div class="col-md-4">
                            <ul class="list-group summary column no-border">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <span class="col-md-8 font-blue-steel ">PO20230118001</span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                ...
                <table class="table table-bordered table-striped" id="tbl_po_items">
                    ...
                    <tr>
                        ...
                        <td class="text-align-center">
                            <div class="btn-group">
                                <button class="btn btn-primary inline"><i class="fa fa-search"></i></button>
                            </div>
                        </td>
                    </tr>
                    <tr>
