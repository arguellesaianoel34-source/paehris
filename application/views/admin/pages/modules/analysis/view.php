...
<li>
	<a href="javascript:;"><i class="fa fa-tag fa-fw"></i> 2015-08-02-CPU0221-400 </a>
</li>
</ul>
    <div class="page-toolbar">
        <div class="btn-group pull-right">
        	<button class="btn btn-success btn-fit-height"><i class="fa fa-check fa-fw"></i>Approved</button>
            <button class="btn btn-danger btn-fit-height"><i class="fa fa-times fa-fw"></i>Disapprove</button>
            <button class="btn btn-warning btn-fit-height"><i class="fa fa-refresh fa-fw"></i>Approve w/ Condition</button>
