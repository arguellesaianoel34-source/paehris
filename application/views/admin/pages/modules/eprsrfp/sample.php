        ...
        <div class="portlet light bordered">
            <div class="portlet-title tabbable-line">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-green-haze uppercase"> Request for Payment Generation </span>
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped" id="tbl_po_items">
                    ...
                    <tr>
                        ...
                        <td class="text-align-center">
                            <div class="btn-group">
                                <a href="#frm_create_payment_request" title="Create Request for Payment" data-toggle="ajax-modal" data-arr="" class="btn btn-primary "><i class="fa fa-plus"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
