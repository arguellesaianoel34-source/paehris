        ...
        <div class="col-md-4">
            <div class="portlet light portlet-fit bordered">
                ...
                <div class="portlet-body ">
                    ...
                    <div class="btn-broup">
                        <a class="btn btn-default" href="<?php echo base_url('module/'.$this->uri->segment(2).'/list'); ?>">Back To List</a>
                    </div>
                            ...
                            <ul class="list-trails">
                                <?php if($ts_traill) {
                                    ...
                                    if($ts_trail_cnt>5) {
                                        ...
                                        echo '<a class="pull-right" href="'.base_url('module/'.$this->uri->segment(2).'/data/'.$dataid.'/logs').'">View All ('.$ts_trail_cnt.')</a>';
                                        echo '</li>';
                                    }
