...
$info = $this->model_cad->get_special_services_info($servno);

$appname = $info->appname;
$appaddr = $info->appaddr;

?>

<?php if($info) { ?>
    <div class="row">
        <form class="form-horizontal" method="post" id="frm_cad_pay" action="<?php echo base_url('tellering/payserv'); ?>">
            <div class="col-md-12">
