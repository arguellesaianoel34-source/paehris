...
$trn_qry = $this->db->select('itg.sysid AS dataid,rmt.stageid,fms.flowid,fms.moduleid,fms.levels,itg.status,trm.sysid AS trnflowid,trm.sysid AS trnid,trm.datecreated')
    ->from('inventory_transaction_group AS itg')
    ->join('transaction_request_main_trails AS rmt','rmt.dataid = itg.sysid','inner')
...
if ($trn_qry) {
    ...
    $flowid = $trn_qry->flowid;
    $stageid = $trn_qry->stageid;
    $trnid = $trn_qry->trnid;
}
?>
