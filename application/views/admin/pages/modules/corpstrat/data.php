    ...
    <div class="col-md-6">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-line-chart"></i><span class="caption-subject font-red-flamingo bold uppercase"> System Rates <?php echo ($appdetails->info->systemtype == 1) ? '<small>(Standard)</small>' : ''; ?></span>
                </div>
            </div>
                            ...
                            <div class="tab-content" id="doc_preview_pane">
                                ...
                                ?>
                                    <div class="tab-pane fade in" id="doc_proposal">
                                        <div class="row">
                                            <div class="btn-group">
                                                <a href="javascript:" id="btn_reload_preview" class="btn btn-primary btn-sm inline" data-type="3433"><i class="fa fa-refresh"></i> Refresh</a>
                                                <a href="javascript:" id="btn_open_preview" class="btn btn-primary btn-sm inline" data-type="3433"><i class="fa fa-search"></i> Open in Tab</a>
                                            </div>
                                            <hr>
                                        </div>
                                    </div>
                                        ...
                                        <div class="tab-pane fade in" id="doc_proposal">
                                            <div class="row">
                                                <div class="btn-group">
                                                    ...
                                                    <a href="javascript:" id="btn_open_preview" class="btn btn-primary btn-sm inline" data-type="<?php echo $dox->doctype; ?>"><i class="fa fa-search"></i> Open in Tab</a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
