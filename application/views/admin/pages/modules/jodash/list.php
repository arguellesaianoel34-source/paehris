                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <a type="button" id="btn_trouble_call_info" href="#form_trouble_call_info" data-arr="1,2,3,4" class="btn btn-success" data-toggle="ajax-modal">Add Trouble Info</a>
                                    <a type="button" id="btn_trouble_call_findings" href="#form_trouble_call_findings"  class="btn btn-default" data-toggle="ajax-modal"><span class="badge badge-danger" id="cnt"></span> Update Trouble Call</a>
                                </span>
                            </div>
                        </div>
                    </div>
