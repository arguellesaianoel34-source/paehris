            ...
            <div class="portlet-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_apprehension">
                        <div class="row">
                        <div class="col-md-12" id="ra-details">
                            <div class="row">
                                <div class="col-md-4">Total Amt: <code id="raamt" class="pull-right">0.00</code></div>
                                <div class="col-md-4">Corrected Amt: <code id="coramt" class="pull-right">20,000.00</code></div>
                                <div class="col-md-4">D.Payment Amt: <code id="doamt" class="pull-right">0.00</code></div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">Compromise Amt: <code id="coamt" class="pull-right">0.00</code></div>
                                <div class="col-md-4">
                                    <a label-loading="" label-default="" label-icon="fa-times" href="javascript:;" id="zero-ra-bal" class="btn btn-danger btn-xs" form-ajax-btn="true"><i class="fa fa-times"></i></a>
                                    Balance: <code id="baamt" class="pull-right">0.00</code></div>
                                <div class="col-md-4">Date Issued: <code id="issuedte" class="pull-right">2018-05-27</code></div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">Status: <span id="rastat" class="pull-right"><span class="label label-default">N/A</span></span></div>
                                <div class="col-md-4"></div>
                                <div class="col-md-4">
                                    <button type="button" class="btn btn-info btn-xs pull-right dropdown-toggle" data-toggle="dropdown" aria-expanded="true"> <span>Type</span><i class="fa fa-angle-down fa-fw"></i> </button>
                                    <ul class="dropdown-menu ra-tabs" role="menu" style="right: 15px !important;">
                                        <li class="active"><a data-toggle="tab" href="#rapn" aria-expanded="true">R.A. PN</a></li>
                                        <li class=""><a data-toggle="tab" href="#rahist" aria-expanded="true">Pay Hist.</a></li>
                                    </ul>
                                    <a class="btn btn-primary btn-xs pull-right hidden" id="add_pn_btn" href="#addpnentry">Add P.N.</a>
                                </div>
                            </div>
                        </div>
                        </div>
