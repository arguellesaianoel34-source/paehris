...
if($ts_decode) {
    ...
    $ts_team = (isset($ts_decode->team)) ? $ts_decode->team : false;
    ...
    $tcsource_arr = get_deptartment_info($ts_info->repsource);
    $tcsource = ($tcsource_arr) ? $tcsource_arr->desc : 'N/A';
    $createdby = '('. get_users_info($ts_info->createdby)->username . ') ' . $user_fullname;

    $techissue = $ts_decode->qry->desc;
            ...
            <div class="portlet light portlet-fit bordered">
                ...
                <div class="portlet-body ">
                    <ul class="list-group summary column">
                        ...
                        <li class="list-group-item">
                            <span class="col-md-4 label-name">Tech. Issue</span>
                            <span class="col-md-8 label-default number"><?php echo $techissue;?></span>
                        </li>
                        <li class="list-group-item">
                    ...
                    <div class="btn-broup">
                        <a class="btn btn-default" href="<?php echo base_url('module/25293f2761d658cc70c19515861842d712751bdc/list'); ?>">Back To List</a>
                    </div>
                            ...
                            <ul class="list-trails">
                                <?php if($ts_traill) {
                                    ...
                                    if($ts_trail_cnt>5) {
                                        ...
                                        echo '<a class="pull-right" href="'.base_url('module/25293f2761d658cc70c19515861842d712751bdc/data/'.$dataid.'/logs').'">View All ('.$ts_trail_cnt.')</a>';
                                        echo '</li>';
                                    }
        ...
        <div class="col-md-4">
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class=" icon-layers font-green"></i>
                        <span class="caption-subject font-green bold uppercase"><i class="fa fa-check"></i> Accomplishments</span>
                        <div class="caption-desc font-grey-cascade"></div>
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="mt-element-list">
                        <div class="mt-list-head  list-simple font-black input-group">
                            <input class="form-control" id="input_employee_assign" placeholder="Assign Employee.."/>
                            ...
                            <ul>
                                ...
                                if($ts_team) {
                                    ...
                                    $qry_team_members = $this->db->select('p.firstname, p.lastname, em.empid')
                                        ->from('ticketing_details_assignments AS ta')
                                        ->join('prime_employee_main AS em', 'em.sysid = ta.typesid')
                                        ->join('person AS p', 'p.sysid = em.personid')
                                        ->where(array('ta.ticketid' => $dataid))
                                        ->get();
                    ...
                    <ul class="list-group summary column">
                        <li class="list-group-item">
                            ...
                            <span class="col-md-8 label-default "><?php echo $lastt_action; ?></span>
                        </li>
                        <li class="list-group-item">
                            <span class="col-md-4 label-name">Findings</span>
                            <span class="col-md-8 label-default "><?php echo ($qry_trail_findings) ? get_types_label_format($qry_trail_findings->findingid, false, false, 'top', '', false) : 'None'; ?></span>
                        </li>
                    </ul>
                </div>
            </div>
