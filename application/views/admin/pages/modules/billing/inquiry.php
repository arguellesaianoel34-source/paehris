    ...
    <div class="portlet-title">
        <div class="row">
            ...
            <div class="acct-image-container" style="text-align: center; border-left: 1px solid rgba(0,0,0,0.08); margin-bottom: 5px;">
                <img id="acct_pic" class="img-bordered" data-placement="bottom" src="<?php echo base_url('assets/global/img/person_default.jpg'); ?>" />
            </div>
        </div>
    </div>
    <div class="portlet-body">
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="form-group margin-top-10" style="margin-bottom: 0px;" id="filter_input">
                    <div class="input-group">
                        <select class="form-control" id="input_ar_limit">
                            <option value=""></option>
                        ...
                        <select class="form-control" id="input_ar_month">
                            <option value=""></option>
                            <?php
                            for($mm=1; $mm<=12; $mm++) {
                                //$selected = ($mm==date('m')) ? 'selected' : '';
                                echo '<option value="'.$mm.'">'.date_formating($mm, '!m', 'F').'</option>';
                            }
                            ?>
                        </select>
                        <input class="form-control" id="input_ar_year" value="<?php echo date('Y'); ?>" placeholder="Year.." />
                        <div class="input-group-btn">
                            <button id="btn_filter"  style="height: 35px !important; display: block !important;" type="button" class="btn btn-default btn-icon-only">
                                <i class="fa fa-search"></i>
                            </button>
                            <button id="btn_filter_up" data-val="" style="height: 35px !important; display: block !important;" type="button" class="btn btn-default btn-icon-only">
                                <i class="fa fa-angle-double-up"></i>
                            </button>
                            <button id="btn_filter_down" data-val="" style="height: 35px !important; display: block !important;" type="button" class="btn btn-default btn-icon-only">
                ...
                <ul class="nav nav-tabs tabs-left ar-tab nav-tabs-label" style="min-height: 350px;">
                    ...
                    <li class="active">
                        <a id="tab_ar" data-module="41" href="#billar" data-toggle="tab" aria-expanded="true">
                            <span class="label bg-grey-steel bg-font-grey-steel">EN</span> Billing AR
                        </a>
                    </li>

                    <li class="">
                        <a href="#adjustments" data-module="41" data-toggle="tab" aria-expanded="false">
                            <span class="label bg-grey-steel bg-font-grey-steel">F1</span> Adjustments
                        </a>
                    </li>

                    <li class="">
                        <a href="#readinghist" data-module="41" data-toggle="tab" aria-expanded="false">
                            <span class="label bg-grey-steel bg-font-grey-steel">F2</span> Reading History
                        </a>
                    </li>

                    <li class="">
                        <a id="tab_othinfo" data-module="41" href="#acctdetails" data-toggle="tab" aria-expanded="false">
                    ...
                    <li class="">
                        <a href="#ticket" data-module="41" data-toggle="tab" aria-expanded="false">
                    ...
                    <li class="">
                        <a href="#pninq" data-module="41" data-toggle="tab" aria-expanded="false">
                            <span class="label bg-grey-steel bg-font-grey-steel">F5</span> P.N. Inquiry
                        </a>
                    </li>

                    <li class="">
                        <a href="#tagging" data-module="41" data-toggle="tab" aria-expanded="false">
                    ...
                    <li class="">
                        <a href="#meterhist" data-module="41" data-toggle="tab" aria-expanded="false">
                            <span class="label bg-grey-steel bg-font-grey-steel">F9</span> Meter History
                        </a>
                    </li>

                    <li class="">
                        <a href="#payments" data-module="41" data-toggle="tab" aria-expanded="false">
                ...
                <div class=" tab-content">
                    <div class="tab-pane active fade in" id="billar">
                        ...
                        <div class="row margin-bottom-10">
                            <div class="col-md-3" style="padding: 20px 20px; padding-left: 30px;">
                                <ul class="list-group summary column no-border">
                                    <li class="list-group-item"> <i class="fa fa-square text-danger"></i> Total Blance: <span class="label label-default pull-right" id="amt_balance" style="color: red;">0.00</span> </li>
                                    <li class="list-group-item"> <i class="fa fa-square text-success"></i> Total Paid: <span class="label label-default pull-right" id="amt_paid">0.00</span> </li>
                            ...
                            <div class="col-md-3" style="padding: 20px 20px; margin-top: 5px; border-left: 1px solid #ccc">
                                <ul class="list-group summary column no-border">
                                    <li class="list-group-item"> Total Interest: <span class="label label-default pull-right" id="amt_interest">0</span> </li>
                                    <li class="list-group-item"> Last Pay Date: <span class="label label-default pull-right" id="lastpay">0000-00-00</span> </li>
                        ...
                        <div class="btn-group pull-right">
                            <button id="tagtowatchlist" class="btn btn-xs btn-default"><i class="fa fa-bell-o"></i> Tag To Watch-List</button>
