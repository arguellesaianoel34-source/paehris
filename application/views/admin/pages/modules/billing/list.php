            ...
            <div class="portlet-body">
                <div class="row">
                    ...
                    <div class="col-md-12 margin-top-10">
                        ...
                        <table width="100%" class="table table-condensed table-bordered table-striped table-hover tbl-sm" id="tbl_billing">
                            <thead>
                            <tr>
                                <th colspan="6" style="text-align: left !important; border-bottom: 1px #ccc solid;" class="info">Account Details</th>
                                <th colspan="2" style="text-align: center !important; border-bottom: 1px #ccc solid;" class="warning">Bills</th>
                                <th colspan="3" style="text-align: center !important; border-bottom: 1px #ccc solid;" class="danger">Payables</th>
                                <th></th>
                            </tr>
                            <tr>
                                <th>#</th>
...
<script src="<?php echo base_url(); ?>assets/pages/paebilling/billing.js" type="text/javascript"></script>
<script>
    BILLING.list();
</script>