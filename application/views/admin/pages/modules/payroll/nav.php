...
<div class="row margin-bottom-10">
    <div class="col-md-7">
        ...
        <div class="row">
            ...
            <?php
            $haspaytypearr = array(128,3077,3078);
            if(in_array($payclass , $haspaytypearr)) { ?>
            ...
            <?php if($payclass!=128) { ?>
              <!--  <div class="col-md-3">
                    <div class="form-group">
                        <label>Bonus</label>
                        <input type="checkbox" name="bonuscheck" id="bonuscheck" class="form-control" />
                    </div>
                </div> -->
            <?php } ?>
        </div>
    ...
    <div class="col-md-5">
        <div class="btn-group pull-right margin-top-20">
            ...
            <?php } ?>
            <?php if(user_id() == 1 || in_array(21, get_users_roles_matrix_id_arr())) { ?>
