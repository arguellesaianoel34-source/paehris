...
$trans = $this->db->select('trmt.*,	tfms.`desc` , tfms.levels')
...
<div class="tab-pane fade in <?php ($task_flow == false) ? 'active' : ''; ?>" id="data">
    <div class="row">
        ...
        <div class="col-md-4">
            <?php echo customer_application_charges_list($dataid); ?>
            <?php echo customer_application_requirements_list($dataid); ?>
            <?php echo ($trans && $trans->levels == 7) ? customer_application_inspection_list($dataid) : ''; ?>
        </div>
    </div>
</div>
