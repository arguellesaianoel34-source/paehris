                ...
                <div class=" light" id="">
                    ...
                    <div class="portlet-body form">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                <td>
                                    <div class="form-group input-group-lg margin-top-10">
                                        <label class="col-md-2 control-label">Business Name <span class="required"></span></label>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            <input class="form-control input-lg" onclick="this.select()" placeholder="Branch name..." name="corpbranch" id="corpbranch" value="" />
                                            <div class="form-control-focus"> </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group margin-top-10">
                                        <label class="col-md-2 control-label person-name" for="name">Owner/Representative <span class="required"></span></label>
                                        <div class="col-md-3 select2-data-flat">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="form-control-focus"> </div>
                                            <span class="help-block"><b>(Optional)</b> Representative Position.</span>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <label class="control-label col-md-2">Business Address <span class="required"></span>
                                        </label>
