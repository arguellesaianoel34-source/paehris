...
<div  id="form_wizard_1">
            ...
            <ul class="nav nav-pills nav-justified steps">
                ...
                <li>
                    <a href="#tab2" data-toggle="tab" class="step">
                        ...
                        <span class="desc"><i class="fa fa-check"></i> Address Setup </span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="#tab4" data-toggle="tab" class="step">
                        ...
                        <span class="desc"><i class="fa fa-check"></i> Verification </span>
                    </a>
                </li>
                <li>
    ...
    <div class="row">
        <form role="form" class="form-horizontal asset-entry-form"  action="<?php echo base_url(); ?>cad/savenewaccount" method="post" id="frm_newaccount">
            ...
            <input type="hidden" name="apptype" value="2" id="input_apptype"/>
            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="tab-content margin-top-20">
                                            ...
                                            <div class="portlet light">
                                                <div class="portlet-title">
                                                    ...
                                                    <span class="pull-right">
                                                        ...
                                                        <input class="form-control" name="essrno" placeholder="0" id="newessrno" />
                                                        </div>
                                                    </span>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label input-group-lg">
                                                        <label class=" control-label col-md-2">Corporation Name</label>
                                                        <div class="col-md-6 input-icon left">
                                                            <i class="fa fa-building"></i>
                                                            <input class="form-control input-lg" placeholder="Corporation name..." name="corpname" id="corpname" />
                                                            <span class="help-block">Indicate corporation name.</span>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input class="form-control input-lg" onclick="this.select()" placeholder="Branch name..." name="corpbranch" id="corpbranch" value="Iloilo" />
                                                            <span class="help-block"><b>(Optional)</b> Indicate branch name if applicable.</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class=" control-label col-md-2"></label>
                                                        <div class="col-md-10"><hr style="margin-top: 20px;"></div>
                                                    </div>
                                                    <div class="form-group form-md-line-input form-md-floating-label rep">
                                                        <label class=" control-label col-md-2">Owner or Representative</label>
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <input id="middlename"  class="form-control" placeholder="Middle Name.. " name="middlename" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <span class="help-block"><b>(Optional)</b> Indicate position of the representative.</span>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="reptemp">
                                                                <input class="form-control" type="checkbox" placeholder="" name="reptemp" id="reptemp"/>
                                                                Temporary
                                                            </label>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            ...
                                            <div class="form-group  form-md-line-input  margin-bottom-20">
                                                <label class="control-label col-md-2">Specific / Landmarks <span class="required">
                                                            * </span></label>
                                                <div class="col-md-6">
                                                    <textarea class="form-control" rows="3" id="addrspecific" name="addrspecific" placeholder="Ex: #12 General Luna Street / PECO"></textarea>
                                                    <span class="help-block">
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group margin-top-20 form-md-line-input crit">
                                                    <label class="col-md-2 control-label" for="acct_rate">Purpose of Connection</label>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group margin-top-20 form-md-line-input crit">
                                                    <label class="col-md-2 control-label" for="stat_conn">Type of Connection</label>
                                                    <div class="col-md-10">
                                                        <!-- accttype -->
                                                        <input id="stat_conn" name="accttype" type="text" class="form-control input-sm data-entry" placeholder="Click to add Customer's Status Connection">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group margin-top-20 form-md-line-input crit">
                                                    <label class="col-md-2 control-label" for="loc_type">Property Owner</label>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group margin-top-20 form-md-line-input">
                                                    <label class="col-md-2 control-label" for="">Requirements </label>
                                                    <div class="col-md-10">
                                        ...
                                        <div class="tab-pane active" id="tab4">
                                            <h3><span id="verify_loading"></span> Verifying Identity</h3>
                                            <hr>

                                            <div class="row">

                                                <div class="col-md-6">
                                                    <h3>Details Verification</h3>
                                                    <ul class="list-group summary column">
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">ESSR No</span>
                                                            <span class="col-md-8 label-default" id="app_essrno">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Corporation Name</span>
                                                            <span class="col-md-8 label-default" id="app_cname">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Corporation Branch</span>
                                                            <span class="col-md-8 label-default" id="app_bcname">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">First Name</span>
                                                            <span class="col-md-8 label-default" id="app_fname">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Middle Name</span>
                                                            <span class="col-md-8 label-default" id="app_mname">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Last Name</span>
                                                            <span class="col-md-8 label-default" id="app_lname">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Email Address</span>
                                                            <span class="col-md-8 label-default" id="app_email">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Birthday</span>
                                                            <span class="col-md-8 label-default" id="app_birthday">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Contact Mobile</span>
                                                            <span class="col-md-8 label-default" id="app_mobile">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Contact Phone</span>
                                                            <span class="col-md-8 label-default" id="app_phone">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">District</span>
                                                            <span class="col-md-8 label-default" id="app_district">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Address</span>
                                                            <span class="col-md-8 label-default" id="app_address">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <span class="col-md-3 label-name">Account</span>
                                                            <span class="col-md-8 label-default" id="app_account">N/A</span>
                                                            <span class="col-md-1 label-default" id="item_check_stats"><i class="fa fa-spinner fa-spin fa-pulse pull-right"></i></span>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <h3>Summary Verification</h3>
                                                    <ul id="verfiy_result"></ul>
                                        ...
                                        <div class="tab-pane" id="tab5">
                                            <div class="col-md-6">
                                                ...
                                                <ul class="list-group summary column">
                                                    <li class="list-group-item list-group-item-info">Profile Summary</li>
                                                    <!-- <li class="hidden corp-name list-group-item" ><div class="row"><span class="label-name col-md-3">Corp. Name </span><span class="label label-default col-md-9 pull-right"><span id="corponame"></span></li> -->
                                                    <li class="list-group-item"><span class="person-name label-name col-md-3">Corporation </span><span class="label label-default col-md-9 pull-right"><span id="pref"></span>&nbsp;<span id="cname"></span>&nbsp;<span id="suff"></span></span></li>
                                                    <li class="list-group-item"><span class="person-name label-name col-md-3">Branch </span><span class="label label-default col-md-9 pull-right"><span id="pref"></span>&nbsp;<span id="cbname"></span>&nbsp;<span id="suff"></span></span></li>
                                                    <li class="list-group-item"><span class="person-name label-name col-md-3">Name </span><span class="label label-default col-md-9 pull-right"><span id="pref"></span>&nbsp;<span id="name"></span>&nbsp;<span id="suff"></span></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Gender </span><span class="label label-default col-md-9 pull-right" id="gender"></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Date of Birth </span><span class="label label-default col-md-9 pull-right" id="dob"></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Marital Status </span><span class="label label-default col-md-9 pull-right" id="mstatus"></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Phone Number </span><span class="label label-default col-md-9 pull-right" id="pnumber"></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Mobile Number </span><span class="label label-default col-md-9 pull-right" id="mnumber"></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Email Address </span><span class="label label-default col-md-9 pull-right" id="emailadd"></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Address </span><span class="label label-default col-md-9 pull-right"><span id="city"></span>&nbsp;<span id="district"></span>&nbsp;<span id="country"></span></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Specific/Landmarks </span><span class="label label-default col-md-9 pull-right" id="landmark"></span></li>
                                                </ul>

                                                <ul class="list-group summary column">
                                                    <li class="list-group-item list-group-item-info">Account Summary</li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Account Rate </span><span class="label label-default col-md-9 pull-right" id="arate"></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Status of Connection </span><span class="label label-default col-md-9 pull-right" id="atype"></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Type of Owner </span><span class="label label-default col-md-9 pull-right" id="ctype"></span></li>
                                                    <li class="list-group-item"><span class=" label-name col-md-3">Type of Location </span><span class="label label-default col-md-9 pull-right" id="ltype"></span></li>
                                                </ul>
                                            ...
                                            <div class="col-md-6">
                                                <ul class="list-group summary column">
                                                    <li class="list-group-item list-group-item-info">Requirements</li>
                                                    <li class="list-group-item">
                                                        <span class="col-md-12">
                                                            <table id="tbl_summary_req" class="table table-hover table-condensed">
                                                                <thead>
                                                                <th></th>
                                                                <th>Name</th>
                                                                </thead>
                                                ...
                                                <hr>
                                                <button id="btn_print_req" type="button" class="btn btn-default"><i class="fa fa-print"></i> Print Requirements</button>
                                            </div>
