    ...
    <div class="col-md-9">
        <div class="portlet light table">
            ...
            <div class="portlet-body">
                <hr>
                <table class="table table-bordered table-hover table-condensed" id="cncpaymenttable">
                    <thead>
                        <th>OR ID</th>
                        <th>Type</th>
                        <th>OR #</th>
            ...
            <div class="portlet-body">
                <ul class="list-group summary column ">
                    <li class="list-group-item">
                        ...
                        <span class="label-default col-md-6 number" id="cncamounttotal">0.00</span>
                    </li>
                    <li class="list-group-item">
                        <span class="label-name col-md-6">Amount Vat</span>
                        <span class="label-default col-md-6 number" id="cncamountvat">0.00</span>
                    </li>
                    <li class="list-group-item">
                        <span class="label-name col-md-6">Amount FR Tx</span>
                        <span class="label-default col-md-6 number" id="cncamountfrtx">0.00</span>
                    </li>
                </ul>
            </div>
        </div>
