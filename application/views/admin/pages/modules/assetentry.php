...
.select2-drop{
    ...
    <div class="row">
		<form role="form" class="form-horizontal asset-entry-form" id="entry-form-ajaxify" action="<?php echo base_url(); ?>query/new_asset_entry" method="post">	
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-helper">New Asset <?php echo user_session()->system_user_sessid; ?></span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
						...
						<div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-error">
                                ...
                                <div class="col-md-10">
                                    <input required name="assetcode" type="text" class="form-control input-sm" id="assetcode" placeholder="Asset Code">
                            ...
                            <div class="form-group form-md-line-input ">
                                ...
                                <div class="col-md-4">
                                    <input name="podate" type="text" class="form-control input-sm" id="podate" placeholder="Search Po Number..">
                                    <div class="form-control-focus">
                                    </div>
                                ...
                                <label class="col-md-2 control-label" for="ponumber">Warranty</label>
                                <div class="col-md-4">
                                    <input name="warantydate" type="text" class="form-control input-sm" id="waranty" placeholder="Warranty Date">
                                    <div class="form-control-focus">
                                    </div>
                                    <span class="help-block">(dd/mm/yyyy) Warranty date end.</span>
                                </div>
                            ...
                            <div class="form-group margin-top-20 form-md-line-input">
                                <label class="col-md-2 control-label" for="asset_spec">Specification</label>
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-10">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="input-group input-sm">
                                                ...
                                                Change </span>
                                                <input type="file" name="primarypicture" placeholder="Select picture">
                                                </span>
                        ...
                        <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <span class="help-block">Serial Found in Warranty</span>
                                </div>
                         </div>
                         ...
                         <div class="form-group form-md-line-input">
                                <label class="col-md-2 control-label" for="descriptions">Additional Descriptions</label>
                                <div class="col-md-10">
          	...
          	<div class="portlet light">
               <div class="portlet-title">
                    <div class="caption">
                        ...
                        <br>
                        <span class="caption-helper">Leave this part blank if asset is not yet deployed</span>
                    </div>
                </div>
                <div class="portlet-body">
...
$(function(){
	$('#entry-form-ajaxify').submit(function(e){
		...
		$.ajax({
			...
			if(data.qry==true){
				setTimeout(function(){
					PECO.initAlerts(data.msg, 'Success', 'success');
				},1000);
			}else{
				setTimeout(function(){
					PECO.initAlerts(data.msg, 'Warning', 'warning');
				},1000);
			}
		}).fail(function(data){
			PECO.initAlerts('PHP Error', 'System', 'danger');	
		});
	});
