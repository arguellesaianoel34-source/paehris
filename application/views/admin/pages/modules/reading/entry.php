...
<form role="form" class="form-horizontal asset-entry-form" id="frm_submit_reading" action="<?php echo base_url('mrd/submitreading'); ?>" method="post">
    ...
    <input  id="reader_id" value="<?php echo user_id(); ?>" name="userid" type="hidden" class="form-control" placeholder="Select Reader" />
    ...
    <div class="row">
        <div class="col-md-12 well">
            ...
            <div class="col-md-7">
                <code style="font-size: 20px; margin: 0px 0px;">
                    Press [Enter] to save reading!
                </code>
                        ...
                        <div class="col-md-6">
                            <ul class="list-group summary no-border">
                                <li class="list-group-item">
                                    ...
                                    <span class="col-md-6 label label-default" id="avkwh">
                                    0.00
                                    </span>
                                </li>
                            </ul>
