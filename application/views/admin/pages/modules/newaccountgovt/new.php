...
<div  id="form_wizard_1">
    ...
    <div class="row">
        <form role="form" class="form-horizontal asset-entry-form"  action="<?php echo base_url(); ?>cad/savenewaccount" method="post" id="frm_newaccount">
            ...
            <input type="hidden" name="apptype" value="3" id="input_apptype"/>
            <div class="col-md-12">
                                            ...
                                            <div class="portlet light">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label input-group-lg">
                                                        <label class=" control-label col-md-2">Government Agency Name</label>
                                                        <div class="col-md-6 input-icon left">
                                                            <i class="fa fa-globe"></i>
                                                            <input class="form-control input-lg" placeholder="Government Agency Name..." name="corpname" id="corpname" />
                                                            <span class="help-block">Indicate governement agency name.</span>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input class="form-control input-lg" placeholder="Branch name..." name="corpbranch" id="corpbranch" />
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label rep">
                                                        <label class=" control-label col-md-2">Representative</label>
                                                        <div class="col-md-4">
