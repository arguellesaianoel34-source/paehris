                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-green-sharp">
                                ...
                                <span class="caption-subject bold uppercase">Transaction Code:  hfhosfiohsfihjsfiphjsdijhiodhid
								
								<!-- ########### Ed's code ## Comment Out ### -->
                                <?php 
                                   $dataid = ($this->session->flashdata('accountid')) ?: $this->input->post('dataid');
									
                                    $trn = ($this->session->flashdata('trn')) ?: $this->input->post('trn');
                                    ...
                                    $account_type_val = ($this->session->flashdata('account_type_id')) ?: '';
                                    $inspection_date_val = ($this->session->flashdata('inspection_date')) ?: '';
                                    $district_val = ($this->session->flashdata('district_id')) ?: '';
                                    $city_val = ($this->session->flashdata('city_id')) ?: '';
                                    $specific_address_val = ($this->session->flashdata('specific_address')) ?: '';
                                    $account_type_name = ($this->session->flashdata('account_type_name')) ?: '';
                                    $district_name = ($this->session->flashdata('district_name')) ?: '';
                                    $city_name = ($this->session->flashdata('city_name')) ?: '';
                                    $address_id = '';
                                    $edited = '';
                                    $rate_id = ($this->session->flashdata('rate_class_id')) ?: 0;
                                    $rate_name = ($this->session->flashdata('rate_class_name')) ?: '';
                                    $x = ($this->session->flashdata('x')) ?: 0;
                                    $y = ($this->session->flashdata('y')) ?: 0;
                                    $form_action = base_url()."query/insertInspectionData";
                                    ...
                                    if ($status == 2 || $status == 1){
                                        ...
                                        $form_action = base_url()."query/updateInspectionData";
                                    }
                                    echo $trn." ".$dataid." ".$status;
                                    
                                    $page = basename(__FILE__, '.php');//get the name of this page for php to know where to return to.
                                    $for_submit = $this->model_inspection_queries->get_hashcode($this->model_admin->get_navigation_specific_details($this->uri->segment(2))->sysid)->hashcode;
                                 ?>
                            </span>
                            </div>
                        </div>
                            ...
                            <form role="form" action="<?php echo $form_action; ?>" method="post" name="form1">
                                <div class="row form-body">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                    <input type="text" class="form-control input-sm <?php echo htmlspecialchars($edited); ?>" id="inspection_date" name="inspection_date" data-date-format="yyyy-mm-dd" value="<?php echo htmlspecialchars($inspection_date_val); ?>" class="active">
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                    <select class="form-control <?php echo htmlspecialchars($edited); ?>" id="district" name="district">
                                                        <?php
                                                            echo "<option value='$district_val'>$district_name</option>";
                                                            $districts = $this->model_inspection_queries->get_district();
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                    <select class="form-control <?php echo htmlspecialchars($edited); ?>" id="city" name="city">
                                                        <?php
                                                            echo "<option value='$city_val'>$city_name</option>";
                                                            $cities = $this->model_inspection_queries->get_city();
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <textarea class="form-control <?php echo htmlspecialchars($edited); ?>" rows="3" id="specific_address" name="specific_address"><?php echo htmlspecialchars($specific_address_val); ?></textarea>
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="input-group" name="lol">
                                                    ...
                                                    <span class="input-group-btn">
                                                        ...
                                                        <button class="btn blue-madison fa fa-camera tooltips" data-container="body" data-placement="top" data-original-title="Capture map coordinates" id="capture" name="capture"></button>
                                    ...
                                    <div class="col-md-6">
										...
										<div class="caption  text-align-left">
                                            ...
                                            <div class="col-md-6">
													<div class="form-group form-md-line-input form-md-floating-label">
														<select class="form-control <?php echo htmlspecialchars($edited); ?>" id="rate_class" name="rate_class">
															<?php
																echo "<option value='$rate_id'>$rate_name</option>";
																$rate_class = $this->model_inspection_queries->rate_class();
																foreach($rate_class as $row){
																	$name = $row->classifications;
																	$id = $row->sysid;
																	echo "<option value='$id'>$name</option>";
																}
															?>
