                ...
                <div class="portlet-body">
                            ...
                            <ul>
                                ...
                                if($ts_team) {
                                    ...
                                    $qry_team_members = $this->db->select('p.firstname, p.lastname, em.empid')
                                        ->from('emp_team_schedule AS eta')
                                        ->join('prime_employee_main_workshift AS ems', 'eta.shiftid = ems.sysid')
                                        ->join('prime_employee_main_workshift_matrix AS emsm', 'emsm.workshift_id = ems.sysid')
                                        ->join('prime_types_parameter AS tp', 'tp.sysid = eta.teamid')
                                        ->join('prime_employee_main AS em', 'em.sysid = emsm.empid')
                    ...
                    <ul class="list-group summary column">
                        ...
                        <li class="list-group-item">
                            ...
                            <span class="col-md-8 label-default "><?php echo ($qry_trail_equipments) ? get_types_label_format($qry_trail_equipments->equipid, false, false, 'top', '', false) : 'None'; ?></span>
                        </li>
                        <li class="list-group-item">
