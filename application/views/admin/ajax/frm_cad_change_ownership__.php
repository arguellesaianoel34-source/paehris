    ...
    <form action="<?php echo base_url();?>cad/editowner" method="post" id="frm_ownership_edit">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3>Current Authorized Representative / Owner</h3>
                    <div class="row">
                        <div class="col-md-5">
                            <h4 class="text-primary text-bold">Name</h4>
                            <div class="form-group">
                                <label>Last Name</label>
                                <input class="form-control" placeholder="Lastname" name="lastname" id="lastname" value="<?php echo ($info->lastname) ? $info->lastname : ''; ?>" autocomplete="off" required/>
                            </div>

                            <div class="form-group">
                                <label>First Name</label>
                                <input class="form-control" placeholder="Firstname" name="firstname" id="firstname" value="<?php echo ($info->firstname) ? $info->firstname : ''; ?>" required/>
                            </div>
                            <div class="form-group">
                                <label>Middle Name</label>
                                <input class="form-control" placeholder="Middlename" name="middlename" id="middlename" value="<?php echo ($info->middlename) ? $info->middlename : ''; ?>" />
                            </div>
                            <div class="form-group">
                                <label>Birth Date<span class="required"></span></label>
                                <input class="form-control" placeholder="Birthday" name="birthday" id="birthday" value="<?php echo ($info->birthdate) ? $info->birthdate : ''; ?>"/>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="icheck-inline">
                                        ...
                                        if ($gender->num_rows() > 0) {
                                            foreach ($gender->result() as $g) {
                                                ...
                                                echo '<label><input name="type" value="'.$g->sysid.'" type="radio" class="icheck" '.$checked.' required/> '.$g->name.'</label>';
                                            }
                                        }
                                        ?>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="marital" id="select_marital" placeholder="Marital Status..." value="<?php echo ($info->marital) ? $info->marital : ''; ?>" required>
                            </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="contactno" id="contactno" placeholder="09xxxxxx .. "  style="text-transform: uppercase" value="<?php echo ($person->info->mobilephone) ? $person->info->mobilephone : ''; ?>" required>
                            </div>
                            <div class="form-group">
                            <label>Country<span class="required"></span></label>
                            <input class="form-control" name="country" id="select2_country"  value="<?php echo ($info->country) ? $info->country : ''; ?>" required/>
                            </div>
                            <div class="form-group">
                            <label>Region<span class="required"></span></label>
                            <input placeholder="Select region.. " class="form-control" name="region" id="select2_region" value="<?php echo ($info->region) ? $info->region : ''; ?>" required/>
                            </div>
                            <div class="form-group">
                            <label>Province</label>
                            <input placeholder="Select province.." class="form-control" name="province" id="select2_province" value="<?php echo ($info->province) ? $info->province : ''; ?>" required/>
                            </div>
                            <div class="form-group">
                            <label>Municipal / City<span class="required"></span></label>
                            <input placeholder="Select Municipal / City.." class="form-control" name="city" id="select2_citymun" value="<?php echo ($info->city) ? $info->city : ''; ?>" required/>
                            </div>
                            <div class="form-group">
                            <label>Specific Address<span class="required"></span></label>
                            <textarea class="form-control" rows="2" id="addrspecific" name="addrspecific" placeholder="Ex: Blk9 Lot20, DECA Homes Subd., Red Gate, Near Security Guard Outpost"><?php echo ($info->addrspec) ? $info->addrspec : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
