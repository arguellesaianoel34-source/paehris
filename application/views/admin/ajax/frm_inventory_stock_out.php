<?php
?>
<form id="frm_stock_out" method="post" action="<?php echo base_url(); ?>inventory/savestockout">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="icheck-inline">
                            <label>
                                <input data-id="1" type="radio" name="searchtype" class="icheck"> Key-in </label>
                            <label>
                                <input data-id="2" type="radio" name="searchtype" checked class="icheck"> Scan code </label>
                        </div>
                    </div>
                </div>
