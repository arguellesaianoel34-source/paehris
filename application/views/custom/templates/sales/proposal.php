    ...
    <main>
        ...
        if (
            ...
            <div style="display: block;">
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify; padding-top: 13px">
                    <?php
                ...
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    <?php if (!$netmetering) { ?>
                    Based on the result of our assessment, we estimate you would need a <b> <?php echo $app->systemsizename; ?>
                    ...
                    night time power use so you save on the cost of your daytime use.</p>
                    <?php } else { ?>
                        Following our assessment, we recommend a <b> <?php echo $app->systemsizename; ?> solar system</b> for your needs.
                ...
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    ...
                    <?php if (!$netmetering) { ?>
                        ...
                        Now, if we multiplied that by the local rate of <b><?php echo $peso . number_format($durate, 2); ?> per kWh</b>,
                        you're looking at monthly savings of <b class="peso"><?php echo number_format($monthlycost, 2); ?></b> &#8212; assuming you use all that energy during daylight hours.
                        And over the course of a year, that adds up to a conservative estimate of <b class="peso"><?php echo number_format($monthlycost * 12, 2); ?></b> in savings.
                    <?php } else { ?>
                        <?php echo $start.'<b>'.strstr($app->systemsizename, ' ', true).' system</b>'; ?> will generate approximately
                        <b><?php echo number_format($monthlyave, 2); ?> kilowatt-hours (kWh)</b> per month. With your daytime usage, at <b><?php echo $day_usage; ?> kWh monthly</b>,
                        you'll save about <b><?php echo $peso . number_format($day_savings, 2); ?> monthly</b> at the local rate of <b><?php echo $peso . number_format($durate, 2); ?> per kWh</b>.
                        The remaining <b><?php echo number_format($night_usage); ?> kWh</b> can be sold back to the grid at <b><?php echo $peso.number_format($gencharge,4); ?> per kWh buyback rate</b>,
                ...
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    ...
                    and can be financed via installment plans with <b>ZERO down payment</b> of up to 10 years for as low as <b class="peso"><?php echo number_format($maxprop, 2); ?>/month</b>.
                    That cost includes the materials, installation and the monitoring app that allows you to track your solar power production.
                ...
                <ul class="list">
                    <li style="font-size: 13px; padding-left: 0.25em; padding-bottom: 0.25em"> 5 years replacement warranty for inverters. (Outright purchase, 2 years plan and 5 years plan)</li>
                    <li style="font-size: 13px; padding-left: 0.25em; padding-bottom: 0.25em"> Free inverter replacement for the entire duration of 10 years plan.</li>
                    <li style="font-size: 13px; padding-left: 0.25em; padding-bottom: 0.25em"> Free maintenance and Acts of God insurance for 10 years plan.</li>
                    ...
                    <li style="font-size: 13px; padding-left: 0.25em; padding-bottom: 0.25em"> With very low degradation rate per annum compared to conventional panels with a major drop in efficiency yearly.</li>
                    ...
                    <?php if ($netmetering) { ?>
                        <li style="font-size: 13px; padding-left: 0.25em; padding-bottom: 0.25em"> FREE net-metering processing (submission of government and utility documents required).</li>
                    <?php } ?>
                </ul>
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify"></p>
                ...
                <?php if ($app->systemtype == 1 && $buildtime != '') {
                    ...
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">If you need any further details about your system, please feel free to contact us.</p>
                <?php } else {?>
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                        We will be waiting for your confirmation.
                        Once an agreement is signed, we will schedule the date of your installation.
            ...
            <div class="page_break" style="display: block">
                ...
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    <i>
                        ...
                        <b><?php echo number_format($outright / ($monthlycost * 12), 1); ?> years to recover your
                            investment.</b> We computed your recovery using the average <?php echo $distutility; ?> distribution
                        ...
                        results in a yearly savings of <b class="peso"><?php echo number_format($monthlycost * 12, 2); ?></b>.
                    </i>
                </p>
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    <i>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr>
                        <th style="font-family: Arial, Verdana, sans-serif; font-size: 8px; border: 1px solid #000; background: #92CDDC; text-align: center; line-height: 20px">
                            Cost of Utility Purchased Power
                        </th>
                        <th style="font-family: Arial, Verdana, sans-serif; font-size: 8px; border: 1px solid #000; background: #C3E4FB; text-align: center; line-height: 20px">
                            *Utility Comparative Rate
                        </th>
                        <th style="font-family: Arial, Verdana, sans-serif; font-size: 8px; border: 1px solid #000; background: #FFC299; text-align: center; line-height: 20px">
                            Fixed Monthly Payment
                        </th>
                        <th style="font-family: Arial, Verdana, sans-serif; font-size: 8px; border: 1px solid #000; background: #B8CCE4; text-align: center; line-height: 20px">
                            PA Energy Comparative Rate
                        </th>
                        <th style="font-family: Arial, Verdana, sans-serif; font-size: 10px; border: 1px solid #000; background: #FEA022; text-align: center; line-height: 20px">
                            Actual Savings
                        </th>
                    </tr>
                    <tr>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #92CDDC; text-align: center;"><?php echo $peso . number_format($monthlycost, 2); ?>/month</td>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #C3E4FB; text-align: center;"><?php echo $peso . number_format($durate, 2); ?>/kWh</td>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #FFC299; text-align: center;"><?php echo $peso . number_format($maxprop, 2); ?>/month</td>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #B8CCE4; text-align: center;"><?php echo $peso . number_format($maxprop / $monthlyave, 2); ?>/kWh</td>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #FEA022; text-align: center;"><?php echo $peso . number_format($monthlycost - (round($maxprop / $monthlyave, 2, PHP_ROUND_HALF_UP) * $monthlyave), 2); ?>/month</td>
                    </tr>
                    </tbody>
                </table>
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify; font-weight: bold; color: #FF6700">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #92CDDC; text-align: center;"><?php echo $peso . number_format($summerave * $durate, 2); ?>/month</td>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #C3E4FB; text-align: center;"><?php echo $peso . number_format($durate, 2); ?>/kWh</td>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #FFC299; text-align: center;"><?php echo $peso . number_format($maxprop, 2); ?>/month</td>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #B8CCE4; text-align: center;"><?php echo $peso . number_format($maxprop / $summerave, 2); ?>/kWh</td>
                        <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #FEA022; text-align: center;"><?php echo $peso . number_format(($summerave * $durate) - (round($maxprop / $summerave, 2, PHP_ROUND_HALF_UP) * $summerave), 2); ?>/month</td>
                    </tr>
                    </tbody>
                </table>
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify; font-weight: bold; color: #ff0000">
                ...
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    <i>
                        Your <?php echo strstr($app->systemsizename, ' ', true); ?> system can get an energy production of up
                        to <?php echo number_format($summerave, 2); ?>kwh/month during summer. You also have a fixed effective
                        kWh rate for the duration of the 10 years program. As such, the cost of energy produced by your system
                        for both rainy and summer seasons is greater than your fixed monthly payment.
                    </i>
                </p>
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify; color: #6A7BCD">
                    <i>
                        Note: Savings are based on consumption within the property, and are an annual average. Some months are
                        lower and some months are higher.
                    </i>
                </p>
                <?php } else { ?>
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify; font-style: italic">
                        Your solar energy system is set to <b>produce <?php echo number_format($aveprod); ?> kWh per month</b>.
                        During the day, <b><?php echo number_format($day_usage); ?> kWh</b> (equivalent to <b><?php echo number_format($clamp,1); ?> kW of solar capacity</b> subject to actual daytime power usage) will power your home,
                        <b>saving you <?php echo $peso.number_format($day_savings,2); ?></b> per month at the current distribution charge of <b><?php echo $peso.number_format($durate,2); ?> per kWh</b>(subject to change monthly).
                        The remaining <b><?php echo number_format($night_usage); ?> kWh</b> will be sold back to the grid at the current net-metering buyback rate of <b><?php echo $peso.number_format($gencharge,4); ?> per kWh</b> (subject to change monthly),
                        resulting in an additional <b><?php echo $peso.number_format($night_savings,2); ?></b> monthly. Altogether, your monthly savings amount to <b><?php echo $peso.number_format($total_savings,2); ?></b>.
                    </p>
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify; font-style: italic">
                        Now, let's talk return on investment (ROI).
                        With a system cost of <b><?php echo $peso.number_format($outright,2); ?></b>, your annual savings of <b><?php echo $peso.number_format($annual_savings,2); ?></b> mean you'll recoup your investment in approximately <b><?php echo number_format($return_year,2); ?></b> years.
                        That's an impressive <b><?php echo number_format($return_rate,2); ?>%</b> annual gain &#8212; far better than any bank interest rate!
                    </p>
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <tbody>
                        <tr>
                            <th style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #92CDDC; text-align: center; line-height: 20px">
                                Current Utility Bill
                            </th>
                            <th style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #C3E4FB; text-align: center; line-height: 20px">
                                Solar Savings
                            </th>
                            <th style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #FFC299; text-align: center; line-height: 20px">
                                New Power Bill
                            </th>
                        ...
                        <tr>
                            <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #92CDDC; text-align: center;"><?php echo $peso . number_format($bill, 2); ?></td>
                            <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #C3E4FB; text-align: center;"><?php echo $peso . number_format($total_savings, 2); ?></td>
                            <td style="font-family: Arial, Verdana, sans-serif; font-size: 13px; border: 1px solid #000; background: #FFC299; text-align: center;"><?php echo $peso . number_format($bill-$total_savings, 2); ?></td>
                            <!--
                    ...
                    <p style="font-family: Arial, Verdana, sans-serif; color: #AC6100; font-size: 13px; line-height: 15px; text-align: justify; font-style: italic">
                        Disclaimer: Your solar system's monthly energy production can vary due to factors like weather, shading, and panel efficiency.
                        ...
                        Utility rates and net metering buyback rates can also change on a month-to-month basis, impacting your savings.
