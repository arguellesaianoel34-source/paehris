        ...
        <main>
            ...
            if (
                ...
                <div style="display: block;">
                    <p
                        style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 20px; text-align: justify; padding-top: 13px">
                        <?php
                    ...
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 20px; text-align: justify">
                    </p>
                    <p> </p>
                    <p
                        style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 20px; text-align: justify; padding-top: 13px">
                ...
                <p
                    style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 20px; text-align: justify; height: auto; page-break-inside: avoid">
                    <br>
                    <?php if (!isset($corpname) || !isset($app->firstname)) {
                        echo '<br>';
                    } ?>
                </p>
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 20px;">
                    <span
                ...
                <div class="page_break" style="display: block">
                    <p
                        style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 20px; text-align: justify; font-weight: bold; color: #FF6700">
                    ...
                    <?php if (!$netmetering) { ?>
                        ...
                        <p
                            style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 20px; text-align: justify; font-weight: bold; color: #ff0000">
                        ...
                        <p
                            style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 20px; text-align: justify; color: #6A7BCD">
                            <i>
                    ...
                    <?php } else { ?>
                        <p
                            style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 20px; text-align: justify; font-style: italic">
                        ...
                        <p
                            style="font-weight: bold; font-family: Arial, Verdana, sans-serif; font-size: 16px; line-height: 20px; color: #FF6700">
                        ...
                        <p
                            style="font-family: Arial, Verdana, sans-serif; color: #AC6100; font-size: 13px; line-height: 20px; text-align: justify; font-style: italic">
                ...
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 21px; line-height: 20px; text-align: center; font-weight: bold; color: #FF6700">SOLAR PANEL ROOF LAYOUT</p>
                <br>
                <?php
                /*
                if (count($pvl) > 0) {
                    ...
                    foreach ($pvl as $pvimg) {
                        echo '<p style="font-family: Arial, Verdana, sans-serif; font-size: 21px; line-height: 20px; text-align: center; font-weight: bold; color: #FF6700">';
                ...
                <div class="page_break">
                    <p
                        style="font-family: Arial, Verdana, sans-serif; font-size: 21px; line-height: 20px; text-align: center; font-weight: bold; color: #FF6700">
