        ...
        <main>
            ...
            if (
                ...
                <div style="display: block;">
                    <p
                        style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 13px; text-align: justify; padding-top: 13px">
                        <?php
                    ...
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                        Following our assessment, we recommend a <b> <?php echo $app->systemsizename . $hassystem; ?></b> for your
                        needs.
                        This system allows you to utilize solar energy for your daytime use and provides backup power for
                        evening use or emergencies. When the battery depletes, your consumption will seamlessly switch to your
                        electric utility provider.</p>
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    </p>
                    <p
                        style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify;">
                        <?php
                        if ($kwatt < 20) {
                            $start = 'The ';
                        } else {
                        ...
                        ?>
                        <?php echo $start . strstr($app->systemsizename, ' ', true); ?> system is projected to generate
                        approximately
                        <b><?php echo number_format($monthlyave, 2); ?>kWh/month</b>.
                        Given a rate of <?php echo $peso . number_format($durate, 2); ?> per kWh,
                        this translates to monthly savings of <b><span
                                class="peso"><?php echo number_format($monthlycost, 2); ?></span></b>,
                        or an annual savings of <b class="peso"><?php echo number_format($monthlycost * 12, 2); ?></b>.
                    </p>
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    </p>
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                        The system costs <b><?php echo $peso . number_format($outright, 2); ?></b>, which includes materials,
                        installation, and a monitoring app that allows you to track your solar power production.
                        We offer financing options with <b>ZERO down payment</b> of up to 5 years, with monthly installments as
                        low as <b><?php echo $peso . number_format($maxprop, 2); ?>/month</b>.
                        ...
                        <tbody>
                            ...
                            <?php if (isset($threeyrs) && $threeyrs > 0) { ?>
                                <td
                                    ...
                                    <?php echo $peso . number_format($threeyrs, 2); ?>/month</td>
                            <?php } ?>
                            <td
                    ...
                    <ul class="list">
                        <li> 5-year replacement warranty for inverters. (applicable to outright purchase, 2-year plan, and
                            5-year plan)</li>
                ...
                <div class="page_break" style="display: block">
                    ...
                    <ul class="list">
                        <li> <b>Energy Independence</b>: A solar hybrid system allows you to generate and store your own
                            electricity, reducing reliance on the grid.</li>
                        <li> <b>Cost Savings</b>: By using solar power during the day and stored power at night, you can
                            significantly reduce your electricity bills.</li>
                        <li> <b>Backup Power</b>: In the event of a power outage, a solar hybrid system can provide backup
                            power, ensuring your essential appliances continue to run.</li>
                        <li> <b>Environmentally Friendly</b>: Solar power is a renewable energy source that reduces your carbon
                            footprint.</li>
                    </ul>
                </div>
