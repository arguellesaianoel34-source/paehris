        ...
        <?php if (
            ...
            <div style="display: block;">
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify; padding-top: 13px">
                    <?php if (isset($app->firstname)) { ?>
                        <b><?php echo utf8_decode(ucwords(strtolower($app->firstname . ' ' . $app->lastname))); ?></b><br>
                        <?php echo (isset($corpname) && $corpname !='') ? utf8_decode($corpname).'<br>' : ''; ?>
                    <?php } else {?>
                        <?php if (isset($corpname)) { ?>
                            <b><?php echo utf8_decode($corpname); ?></b><br>
                        <?php }}?>
                    <?php echo utf8_decode($app->address); ?>
                </p>
                ...
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    Based on the result of our assessment, we estimate you would need a <b> <?php echo $app->systemsizename; ?>
                        system</b>. This allows you to
                    harness solar energy directly for your daytime use. Your consumption is seamlessly switched to your electric
                    utility
                ...
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    ...
                    ?>
                    <?php echo $start.strstr($app->systemsizename, ' ', true); ?> system will generate conservatively
                    <b><?php echo number_format($monthlyave, 2); ?>kWh/month</b>; multiplied by a rate
                    of <?php echo $peso . number_format($durate, 2); ?> per kWh this
                    translates to <b class="peso"><?php echo number_format($monthlycost, 2); ?>/month</b> worth of savings. That gives you
                    a conservative yearly savings of <b class="peso"><?php echo number_format($monthlycost * 12, 2); ?></b>.</p>
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify"></p>
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">
                    The cost of the system is <b><?php echo $peso . number_format($outright, 2); ?></b> and can be financed via
                    installment plans with <b>ZERO down payment</b> of up to 10
                    years for as low as <b class="peso"><?php echo number_format($maxprop, 2); ?>/month</b>. That cost includes the
                    materials, installation and the monitoring app that allows
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td style="font-family: Arial, Verdana, sans-serif; border-left: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; background: #000; color: #fff; width: 125px; text-align: center;"><?php echo strstr($app->systemsizename, ' ', true); ?> System</td>
                    <td style="font-family: Arial, Verdana, sans-serif; border-left: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; background: #c5d9f1; text-align: center;"><?php echo $peso . number_format($outright, 2); ?></td>
                    <td style="font-family: Arial, Verdana, sans-serif; border-left: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; background: #8db4e2; text-align: center;"><?php echo $peso . number_format($twoyrs, 2); ?>/month</td>
                    <td style="font-family: Arial, Verdana, sans-serif; border-left: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; background: #538dd5; text-align: center;"><?php echo $peso . number_format($fiveyrs, 2); ?>/month</td>
                    <?php if (isset($tenyrs) && $tenyrs > 0) { ?>
                    <td style="font-family: Arial, Verdana, sans-serif; border-left: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; background: #fabf8f; border-right: 1px solid #000; text-align: center;"><?php echo $peso . number_format($tenyrs, 2); ?>/month</td>
                    <?php } ?>
                    </tr>
                    </tbody>
                </table>
                ...
                <?php if ($app->systemtype == 1 && $buildtime != '') {
                    ...
                    ?>
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">We
                        will be waiting for your confirmation. Once an agreement is signed, we will schedule the date of your
                        installation. <?php echo ($app->systemtype == 1 && $buildtime != '') ? 'The estimated time for completion of the system installation will be '.$buildtime.$day.'.' : '';?>
                    </p>
                ...
                <?php } else {?>
                    <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify">We
                        will be waiting for your confirmation. Once an agreement is signed, we will schedule the date of your
                        installation. If you need any further details about your system, please feel free to contact us.</p>
                ...
                <p style="font-family: Arial, Verdana, sans-serif; font-size: 13px; line-height: 15px; text-align: justify"><br><br><br></p>
