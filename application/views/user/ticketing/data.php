<style>
    ...
    .modal{
        ...
        <div class="col-md-12" style="padding:80px 40px 40px 40px;">
            ...
            <a class="pull-right btn default" data-toggle="modal" href="#modal_ticketentry" id="addticketbtn">
                        ...
                        <div class="col-md-6">
                            <h3>Update</h3>
                                    ...
                                    <input type="hidden" name="ticket_id" id="ticket_id" value=""/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>Status<span class="required">
													 </span>
                                                </label>
                                            </div>
                                            <div class="col-md-5">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>Department <span class="required">
													</span>
                                                </label>
                                            </div>
                                            <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>Findings <span class="required">
													 </span>
                                                </label>
                                            </div>
                                            <div class="col-md-8">
