...
//**************************************************
// This class provides an alternative implementation of the SimpleXML API
// that works under PHP 4, so applications that need to run under environments
// on which only PHP 4 is available can take advantage of the SimpleXML API benefit

// the original class was created by Taha Paksu
// http://www.phpclasses.org/browse/package/4484.html

// the original class was modified by Chris Brainard
// floweringmind@gmail.com
// so that it would work with codeigniter
